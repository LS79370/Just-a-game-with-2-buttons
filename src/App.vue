    ...
    export default {
        ...
        data() {
            return {
                ...
                missionlist: [ //liste des missions
                    ...
                    /* Au lieu de tout le temps retirer des ressources, en ajouter? le vendeur redonne du carburant non?*/
                    ...
                    "2 membres de votre équipe nuisent à l'ambiance du groupe, mais ils s'agissent des ouvriers en chef de l'aile est du vaisseau. A vous de choisir quoi sacrifier entre la cohésion du groupe (-2) et l'entretien du vaisseau(-3)...",
                    ...
                    "Vous arrivez presque à destination : un martien s'échappe du vaisseau avec les chips préférées de 3 vos subordonnés! Mais il va dans la direction opposée du vaisseau... faites demi-tour (-3) pour faire plaisir à votre équipage ou laissez-les y aller seuls (-3).",
                    "Il y a une mutinerie dans votre vaisseau, protégez-vous en condamnant l'accès au pont (-2) ou laissez-les vous approcher et tuez les mutins (-4).",
                ],
        ...
        methods: {
            ...
            Victoire: function () { //Vous avez gagné
                ...
                this.Titre = "VICTOIRE!";
                this.mission = "Vous avez réussi! Vous êtes arrivés à atteidre la planète Mars! Certes, vous avez perdu des compagnons, et votre vaisseau ressemble à une épave. Mais, vous avez réussi!";
